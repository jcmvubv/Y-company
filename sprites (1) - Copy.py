...
class Sky(pygame.sprite.Sprite):
    ...
    def __init__(self, screen):
        ...
        self.image = pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\sky.jpg")
...
class Cloud(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, variable):
        ...
        self.image = pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\cloud" + str(randnum) + ".png")
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, ground, centerx, bottom):
        ...
        self.__player_list_shield = [pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\DoodleSL1.png") \
            , pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\DoodleSR1.png")]

        # Load the images of normal player into a list
        self.__player_list = [pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\DoodleL1.png"), \
                              pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\DoodleR1.png")]

        # Set player's image as one of the normal-list images
        self.image = self.__player_list[0]#initial normal left image
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, x, y):
        ...
        self.image = pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\ball.png")
        self.rect = self.image.get_rect()
...
class Monster(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, welcome, x, y):
        ...
        for number in range(4):
            self.__monster_images.append(pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\alienR" \
                                                           + str(number) + ".png"))
...
class Star(pygame.sprite.Sprite):
    ...
    def __init__(self, screen, welcome):
        ...
        for number in range(12):
            self.__star_images.append(pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\star" + \
                                                        str(number) + ".png"))
...
class Shield(Star):
    ...
    def __init__(self, screen):
        ...
        self.image = pygame.image.load("E:\\CloudJumper-master\\CloudJumper-master\\Images\\shield.png")
...
class ScoreKeeper(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.__font = pygame.font.Font("E:\\CloudJumper-master\\CloudJumper-master\\EHSMB.ttf", 30)
        self.__score = 0
    ...
    def update(self):
        ...
        # Render and set rect
        self.image = self.__font.render(message, 1, (255, 255, 0))#yellow colour
        self.rect = self.image.get_rect()
        self.rect.left = 5
        self.rect.top = 15
